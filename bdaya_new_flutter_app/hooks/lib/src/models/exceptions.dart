...
/// {@template bdaya_new_flutter_app_exception}
/// An exception thrown by the `bdaya_new_flutter_app` hooks.
/// {@endtemplate}
abstract class BdayaNewFlutterAppHooksException implements Exception {
  /// {@macro bdaya_new_flutter_app_exception}
  ...
  @override
  String toString() => '''
[$BdayaNewFlutterAppHooksException] $description.
...
/// given.
/// {@endtemplate}
class InvalidAndroidApplicationIdFormat
    extends BdayaNewFlutterAppHooksException {
